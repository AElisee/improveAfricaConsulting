...
const About = () => {
  return (
    <AnimatePresence>
      <motion.div
        className="h-full"
        initial={({ opacity: 0 }, { x: "360px" })}
        animate={({ opacity: 1 }, { x: 0 })}
        exit={{ opacity: 0 }}
        transition={{ duration: 0.6, ease: "easeOut" }}
      >
        {/* IMAGE */}
        <div className="w-full h-[300px] md:h-[400px] p-3 md:p-8 lg:pb-5  border about bg-cover bg-center">
        ...
        <div className=" p-3 lg:p-8">
          ...
          <p className="leading-7 text-md">
            ...
            mission de contribuer à l’amélioration du cadre de vie de la société
            à travers des études rigoureuses.
          </p>
        </div>
        {/*  NOS VALEURS */}
        <div className="p-3 lg:p-8 bg-gray-100">
          ...
          <div className="h-full w-10/12 mx-auto ">
            <img src="./assets/valeur.webp" alt="" className="w-full h-full" />
          </div>
        </div>
        {/* COMPOSANT TEAM */}
        <Team />
