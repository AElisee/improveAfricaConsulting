...
const Team = () => {
  const Card = ({ member }) => {
    return (
      <div
        className="t-card w-11/12 md:w-[520px] h-full md:h-[320px] rounded-2xl shadow-md p-5 m-1 flex flex-col "
        data-aos="zoom-in"
        data-aos-offset="0"
      >
        ...
        <div className="h-2/3 bottom color_5 flex items-center text-sm md:text-md left-6 leading-6 ">
  ...
  return (
    <div className="team bg-white p-5 md:p-8">
      <div className="mw-1200 m-0-auto">
        ...
        <h4 className="text-md md:text-lg font-semibold mb-8">
